...
/*
    Added in function to fix JS error "Cannot read property ‘toggleOverlay’"
    More info:
    https://themeforest.net/item/pages-admin-dashboard-template-web-app/9694847/comments?page=110
 */
(function($) {
    ...
    $(document).ready(function() {
        ...
        $('[data-pages="search"]').search({
            ...
            onSearchSubmit: function(searchString) {
                // var size = JSON.parse("<%= Instrument.count %>")
                // console.log("size is " + size);

                location.assign("/instruments/show?commit=1&symbol=" + searchString);
                // $.ajax({url: "/instruments/search_instruments?search_string=" + searchString, type: "POST"});
            },
            ...
            onKeyEnter: function(searchString) {
                ...
                $.ajax({url: "/instruments/search_instruments?search_string=" + searchString,
                        success:function(data) {
                          $('#instrument_search_results').html(data)
                        }, type: "POST"});
